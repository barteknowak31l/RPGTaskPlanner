...
public class CircleFillView extends View
{
    ...
    public CircleFillView(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            fillColor = a.getColor(R.styleable.CircleFillView__fillColor, Color.WHITE);
            strokeColor = a.getColor(R.styleable.CircleFillView__strokeColor, Color.BLACK);
            strokeWidth = a.getFloat(R.styleable.CircleFillView__strokeWidth, 1f);
            value = a.getInteger(R.styleable.CircleFillView__value, 0);
            adjustValue(value);
        }
        finally
        {
